const contractAddress = "0x994268493A93aDbD25355a03dFc5f3E4FDC0bb2D"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Devilish Adventures NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Devilish Adventures NFT Project. Born in 18th century, Mr. Devilick Solarfields is on a time travelling journey in many worlds. This collection portraits his journey to first three worlds, Jiggly Hell, Pinky Mountains and Spongy World';
